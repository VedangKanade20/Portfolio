        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with programming and I have learnt some good suff,
              I think… 🤷‍♂️
              <br />
              ...
              <i>
                <b className="purple">Web Applications and Projects </b> and
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/VedangKanade"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/vedang__k/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
